...
const ListesL3EDT = () => {
    ...
    const handlePrintSingle = (parcoursId: string) => {
        ...
        const niveauDetails = getNiveauDetails(niveauL3Id);
    ...
    const handlePrintAll = () => {
        ...
        let printContent = `
            <html>
                <head>
                    <title class="title">Emplois du temps L3 - ${selectedDateDebut || getLatestDateDebut()}</title>
                    <style>
                        body { font-family: Arial, sans-serif; margin: 20px; }
                        .title{ text-align: right; position: absolute; right: 0; }
                        .print-header { text-align: center; margin-bottom: 20px; }
                ...
                <body>
                    <div class="print-header">
                        <div class="print-title">Emplois du temps L3</div>
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Filtrer seulement les EDT pour L3
                const edtsL3 = edtsData.filter(edt => edt.IDNiveaux === niveauL3Id);
                ...
                const grouped = groupCreneauxByTime(edtsL3, creneauxData);
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            // Filtrer seulement les EDT pour L3
            const edtsL3 = data.filter(edt => edt.IDNiveaux === niveauL3Id);
        ...
        return (
            <div className="card shadow border-0 p-3 mt-4" key={parcoursId}>
                <div className="fa-reg-plus-square-container ensbl">
                    ...
                    <div className='add'>
                        <a href={`/edtFrm?niveau=${niveauL3Id}&parcours=${parcoursId}`}><FaRegPlusSquare className='icn' /></a>
                    </div>
                </div>
            ...
            <div className="edt-container">
                <div className="right-content w-100">
                    <div className="card shadow border-0 w-100 flex-row p-4">
                        <h5 className="mb-0">Emploi du temps de L3</h5>
