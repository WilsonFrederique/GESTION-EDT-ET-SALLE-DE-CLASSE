...
const ListesM2EDT = () => {
    ...
    const handlePrintSingle = (parcoursId: string) => {
        ...
        const niveauDetails = getNiveauDetails(niveauM2Id);
    ...
    const handlePrintAll = () => {
        ...
        let printContent = `
            <html>
                <head>
                    <title class="title">Emplois du temps M2 - ${selectedDateDebut || getLatestDateDebut()}</title>
                    <style>
                        body { font-family: Arial, sans-serif; margin: 20px; }
                        .title{ text-align: right; position: absolute; right: 0; }
                        .print-header { text-align: center; margin-bottom: 20px; }
                ...
                <body>
                    <div class="print-header">
                        <div class="print-title">Emplois du temps M2</div>
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Filtrer seulement les EDT pour M2
                const edtsM2 = edtsData.filter(edt => edt.IDNiveaux === niveauM2Id);
                ...
                const grouped = groupCreneauxByTime(edtsM2, creneauxData);
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            // Filtrer seulement les EDT pour M2
            const edtsM2 = data.filter(edt => edt.IDNiveaux === niveauM2Id);
        ...
        return (
            <div className="card shadow border-0 p-3 mt-4" key={parcoursId}>
                <div className="fa-reg-plus-square-container ensbl">
                    ...
                    <div className='add'>
                        <Link to={`/edtFrm?niveau=${niveauM2Id}&parcours=${parcoursId}`}>
                            <FaRegPlusSquare className='icn' />
                        </Link>
                    </div>
                </div>
                                                        ...
                                                        {edtForJour ? (
                                                            <div className="edt-cours-container">
                                                                ...
                                                                <div className="edt-actions-icones">
                                                                    <Link 
                                                                        to={`/modifierEdtFrm/${edtForJour.IDEdt}`}
        ...
        <div>
            ...
            <div className="right-content w-100">
                <div className="card shadow border-0 w-100 flex-row p-4">
                    <h5 className="mb-0">Emploi du temps de M2</h5>
                        ...
                        <div className="filter-group glassmorphism-card">
                            ...
                            <div className="select-wrapper futuristic-select">
                                ...
                                >
                                    ...
                                    {uniqueDateDebuts.map((date, index) => (
                ...
                {selectedParcours ? (
                    ...
                    parcours
                        .filter(parcour => hasEdtsForParcours(parcour.IDParcours))
                        .map(parcour => renderEdtTable(parcour.IDParcours))
                )}
