...
import '../ListesL1EDT/ListesLEDT.css'
import '../EDT.css'
        ...
        <div className="right-content w-100">
            ...
            <div className="card shadow border-0 p-3 mt-4">
                <div className="fa-reg-plus-square-container ensbl">
                    <div>Emploi du temps de L1 <b>(du 1er au 6 avril 2025)</b></div>
                    <div>
                ...
                {/* Parcour : IG */}
                <div>
                    <h1>ENI - Première année ( 1ère ) <strong>Parcour : IG</strong></h1>
                ...
                {/* Parcour : Pro */}
                <div>
                    <h1>ENI - Première année ( 1ère ) <strong>Parcour : Pro</strong></h1>
                    <h2>Du 1er au 6 avril 2025</h2>
