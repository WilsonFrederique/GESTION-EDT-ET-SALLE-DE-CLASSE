...
import '../ListesL2EDT/ListesL2EDT.css'
import '../EDT.css'
            ...
            <div className="right-content w-100">
                ...
                <div className="card shadow border-0 p-3 mt-4">
                    <div className="fa-reg-plus-square-container ensbl">
                        <div>Emploi du temps de L2 <b>(du 1er au 6 avril 2025)</b></div>
                        <div>
                    ...
                    {/* Parcour : IG */}
                    <div>
                        <h1>ENI - Deuxième année ( 2e ) <strong>Parcour : IG</strong></h1>
                    ...
                    {/* Parcour : GB */}
                    <div>
                        <h1>ENI - Deuxième année ( 2e ) <strong>Parcour : GB</strong></h1>
                        <h2>Du 1er au 6 avril 2025</h2>
                    ...
                    {/* Parcour : ASR */}
                    <div>
                        <h1>ENI - Deuxième année ( 2e ) <strong>Parcour : ASR</strong></h1>
                        <h2>Du 1er au 6 avril 2025</h2>
