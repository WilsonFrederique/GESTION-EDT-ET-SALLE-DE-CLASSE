...
const ListesL2EDT = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Filtrer seulement les EDT pour L2
                const edtsL2 = edtsData.filter(edt => edt.IDNiveaux === niveauL2Id);
                ...
                const grouped = groupCreneauxByTime(edtsL2, creneauxData);
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            // Filtrer seulement les EDT pour L2
            const edtsL2 = data.filter(edt => edt.IDNiveaux === niveauL2Id);
        ...
        return (
            <div className="card shadow border-0 p-3 mt-4" key={parcoursId}>
                <div className="fa-reg-plus-square-container ensbl">
                    ...
                    <div className='add'>
                        <a href={`/edtFrm?niveau=${niveauL2Id}&parcours=${parcoursId}`}><FaRegPlusSquare className='icn' /></a>
                    </div>
                </div>
            ...
            <div className="edt-container">
                <div className="right-content w-100">
                    <div className="card shadow border-0 w-100 flex-row p-4">
                        <h5 className="mb-0">Emploi du temps de L2</h5>
