        ...
        <>
            <div className="right-content w-100">
                <div className="card shadow border-0 w-100 flex-row p-4">
                    <h5 className="mb-0">Ajout d’une salle</h5>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-12">
                            <div className="card p-4">
                                <h5 className='mb-4'>Veuillez remplir ces champs pour la salle</h5>
                        ...
                        <div className="col-sm-15">
                            <div className="card p-4 mt-0">
                                <div className="grp-btns-save-annul">
                                    ...
                                    <div className="imagesUploadSec">
                                        <a href="/salleFRM"><Button type='submit' className='btn-dang btn-lg btn-big w-100'><FaTimes /> &nbsp; ANNULER</Button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
